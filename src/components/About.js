  ...
  return (
    <section id="about" className="about-section">
      <div className="about-content">
        <h2>About Me</h2>
        <p>
          Hello! I'm Eyonadab, a passionate web developer who loves creating interactive and dynamic user interfaces. 
        ...
        <p>
          ...
          technologies like React, Node.js, and more. I enjoy learning new frameworks, optimizing code, and staying up-to-date 
